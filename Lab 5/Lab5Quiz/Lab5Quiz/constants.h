...
const uint8_t ebi_ctrla_config = 0b00011101;
...
const uint8_t ebi_baseaddlL_config = 0x80;
const uint8_t ebi_baseaddlH_config = 0x12;
...
const uint8_t ADC_CTRLB_CONFIG = 0b00000100;
...
const uint8_t ADC_CH0_CTRL_CONFIG = 0b00000001;		//0x01
//const uint8_t ADC_CH0_MUXCTRL_CONFIG = 0b0 0001 010;	//0x0A
const uint8_t ADC_CH0_MUXCTRL_CONFIG = 0b00001000;	//0x0A
