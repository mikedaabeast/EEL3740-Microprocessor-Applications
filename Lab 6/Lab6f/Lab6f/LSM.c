...
/*********************Function**************************************
; Function Name: RESET_LSM
; Inputs: No direct inputs
; Outputs: No direct outputs
*/
void RESET_LSM(void){
	//Set the XMEGA SPI slave selects for the
	//accelerometer and gyro to false (high)
	PORTF.DIR = (PIN4_bm | PIN3_bm);//0x18
	PORTF.OUTSET = PIN4_bm;	//SSG
	PORTF.OUTSET = PIN3_bm;	//SSA
	...
	LSM_WRITE(1, CTRL_REG4_A, 0x01);
	
	//Reset the gyroscope
	LSM_WRITE(0, CTRL_REG1_G, 0x00);
