...
.equ counter_check_Red = 200
.equ counter_check_Green = 40
.equ counter_check_Blue = 30
	; COLORS
.equ BIT4 = 0x10
.equ RED = ~(BIT4)
...
IF_GREEN:		
	cpi r19, counter_check_Green	; Compare counter to green max time value
...
IF_BLUE:		
	cpi r19, counter_check_Blue		; Compare counter to blue max time value
